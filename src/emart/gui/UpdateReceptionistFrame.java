...
public class UpdateReceptionistFrame extends javax.swing.JFrame {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jcRecId, 0, 126, Short.MAX_VALUE)
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
     ...
     public int validateInput(){
           if(txtPassword.getPassword().length<4||txtRePassword.getPassword().length<4)
               return 0;
           else if(txtRecName.getText().trim().isEmpty())
               return -1;
           return 1;
       }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
       int result=validateInput();
             ...
             try{
                   boolean r=ReceptionistDAO.updatePassword(txtRecName.getText(), spwd,jcRecId.getSelectedItem().toString());
                   if(r){
                   ...
                   JOptionPane.showMessageDialog(null,"Password can not update due to some error!");
             }
    ...
    private void jcRecIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcRecIdActionPerformed
        txtRecName.setText(al.get(jcRecId.getSelectedItem().toString()));
    ...
    private void loadReceptionistId() {
        try{
           al=ReceptionistDAO.getAllReceptionstId();
            if(al.isEmpty()){
                JOptionPane.showMessageDialog(null,"Receptionist not available");
                return;
            }
            Set<String>keySet=al.keySet();
            Iterator<String>it=keySet.iterator();
            while(it.hasNext()){
                jcRecId.addItem(it.next());
        }
    }
        catch(SQLException ex){
            ex.printStackTrace();
