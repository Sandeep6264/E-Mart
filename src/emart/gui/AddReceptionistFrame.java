...
public class AddReceptionistFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Receptionist Panel", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jcEmpId, 0, 158, Short.MAX_VALUE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
             ...
             if(result==0){
                 JOptionPane.showMessageDialog(this,"Password must be alteast 4 ","password",JOptionPane.INFORMATION_MESSAGE);
                 return;
             }
             if(result==-1){
                 JOptionPane.showMessageDialog(this,"User id cannot be left blank ");
                 return;
             }
             ...
             try{
                 ...
                 if(status==true){
                     ...
                     JOptionPane.showMessageDialog(null,"Receptionist not add");
                 }
             }
              catch(SQLException e){
           JOptionPane.showMessageDialog(this,"DB Erro");
             e.printStackTrace();
       } 
       ...
       try{
           receptionist=ReceptionistDAO.getNonRegisteredReceptionists();
            if(receptionist.isEmpty()){
                JOptionPane.showMessageDialog(this,"No unRegistred Receptionist present ","Registion",JOptionPane.INFORMATION_MESSAGE);
               dispose();
